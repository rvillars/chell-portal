module.exports = function (grunt) {
    ...
    var taskConfig = {
        ...
        copy: {
            ...
            build_vendor_asset_packages: {
                files: [
                    {
                        src: [ '<%= vendor_files.asset_packages %>' ],
                        dest: '<%= build_dir %>/assets/',
                        cwd: 'vendor',
                        expand: true
                    }
    ...
    /**
     * The `watch-karma` task gets your app ready to run for debugging with karma.
     */
    grunt.registerTask('watch-karma', [ 'build-karma', 'karma:unit', 'delta' ]);
    ...
    grunt.registerTask('run', ['open', 'express']);
